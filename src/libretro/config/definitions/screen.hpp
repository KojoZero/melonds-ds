...
namespace MelonDsDs::config::definitions {
    ...
    constexpr retro_core_option_v2_definition ScreenLayout1 {
        ...
        config::screen::CATEGORY,
        {
            ...
            {MelonDsDs::config::values::BOOK, "Book"},
            ...
            {MelonDsDs::config::values::CENTERED_LARGESCREEN_TOP, "Centered Large Screen (Focus Top)"},
            {MelonDsDs::config::values::CENTERED_LARGESCREEN_BOTTOM, "Centered Large Screen (Focus Bottom)"},
